<?php
	...
	*/
	...
	$att = mysql_query("select * from recargasrec where data <> '0000-00-00' order by id desc limit 1");
...
<html>
    <head>
		<link rel="icon" href="/recargass/arquivos/favicon2.png" type="image/x-icon" />
        <title> Estatisticas Recargas - Nome Empresa </title>
            ...
            <header id="cabecalho">
                ...
                <section id="textoCabecalho">
					...
					<div align="right">
						...
						<?php } else { ?>
							<font color="blue" size="-0"> <b> Sistema Atualizado em <?php echo $dataAtt . " as " . $horaAtt?> <br/>
						<?php } ?>
					</div>
					<br/>
					<?php
